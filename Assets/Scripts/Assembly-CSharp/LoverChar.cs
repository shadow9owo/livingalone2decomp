...
public class LoverChar : MonoBehaviour
{
	public static L_CharD _L_CharD;

	public static int L_CharD_N;

	public static int L_Sex;

	public Text obj_Name;

	private void Start()
	{
		L_Sex = PlayerPrefs.GetInt("L_Sex");
		Lovercont.Lovername = PlayerPrefs.GetString("Lovername");
		obj_Name.text = string.Format("{0}", Lovercont.Lovername);
		SetPosition();
		ChangeStart();
	}
	...
	public void SetPosition()
	{
		...
		{
			base.transform.localPosition = new Vector3(-170f, -64f, 0f);
		}
		...
		{
			base.transform.localPosition = new Vector3(-129f, 0f, 0f);
		}
		if (RoomCont.Room_N == 3)
		{
			base.transform.localPosition = new Vector3(-26.4f, -21f, 0f);
		}
		if (RoomCont.Room_N == 4)
		{
			base.transform.localPosition = new Vector3(32f, -25f, 0f);
		}
		...
		{
			base.transform.localPosition = new Vector3(-51f, -213f, 0f);
		}
		...
		{
			base.transform.localPosition = new Vector3(-221f, 61f, 0f);
		}
		if (RoomCont.Room_N == 10)
		{
			base.transform.localPosition = new Vector3(0f, 47f, 0f);
		}
		if (RoomCont.Room_N == 11)
		{
			base.transform.localPosition = new Vector3(-199f, 134f, 0f);
		}
		if (RoomCont.Room_N == 12)
		{
			base.transform.localPosition = new Vector3(0f, -253f, 0f);
		}
		if (RoomCont.Room_N == 13)
		{
			base.transform.localPosition = new Vector3(-82f, 102f, 0f);
		}
		if (RoomCont.Room_N == 14)
		{
			base.transform.localPosition = new Vector3(114f, 191f, 0f);
		}
		if (RoomCont.Room_N == 15)
		{
			base.transform.localPosition = new Vector3(8f, 298f, 0f);
		}
		if (RoomCont.Room_N == 16)
		{
			base.transform.localPosition = new Vector3(-87f, 56f, 0f);
		}
		if (RoomCont.Room_N == 17)
		{
			base.transform.localPosition = new Vector3(31f, -24f, 0f);
		}
	}
	...
	private void FixedUpdate()
	{
		...
		if (_L_CharD == L_CharD.U)
		{
			flag = true;
			zero += Vector3.up;
		}
		else if (_L_CharD == L_CharD.D)
		{
			flag = true;
			zero += Vector3.down;
		}
		if (_L_CharD == L_CharD.L)
		{
			if (!flag)
			{
				zero += Vector3.left;
		...
		else if (_L_CharD == L_CharD.R && !flag)
		{
			zero += Vector3.right;
		}
		if (_L_CharD == L_CharD.S && !flag)
		{
			zero += Vector3.zero;
		}
